...
- **AC-01 [layer: e2e]**: Successfully move candidate to a new stage.
  - **Given** I am on the Application Pipeline page with a candidate in the "Applied" lane
...
- **AC-02 [layer: e2e]**: Archive candidate from the board.
  - **Given** I am on the Application Pipeline page with a candidate in the "Offer" lane
