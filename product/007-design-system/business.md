...
- **Secondary (Black/Deep Gray)**: Used for text, backgrounds of headers, and structural borders.
- **Accent (Yellow)**: Used for warnings or interactive hovers.

### Typography
- Professional sans-serif font family (e.g., Inter or system fonts) with a focus on legibility in data-dense tables and boards.
