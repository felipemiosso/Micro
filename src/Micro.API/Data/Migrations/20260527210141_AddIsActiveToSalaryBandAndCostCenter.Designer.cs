...
namespace Micro.API.Data.Migrations
{
    ...
    [Migration("20260527210141_AddIsActiveToSalaryBandAndCostCenter")]
    partial class AddIsActiveToSalaryBandAndCostCenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Micro.API.Data.Models.JobPostingCustomField", b =>
                {
                    b.Property<Guid>("JobPostingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("JobPostingId", "CustomFieldDefinitionId");

                    b.HasIndex("CustomFieldDefinitionId");

                    b.ToTable("JobPostingCustomFields", (string)null);
                });
            ...
            modelBuilder.Entity("Micro.API.Data.Models.RequisitionCustomField", b =>
                {
                    b.Property<Guid>("RequisitionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("RequisitionId", "CustomFieldDefinitionId");

                    b.HasIndex("CustomFieldDefinitionId");

                    b.ToTable("RequisitionCustomFields", (string)null);
                });
            ...
            modelBuilder.Entity("Micro.API.Data.Models.JobPostingCustomField", b =>
                {
                    b.HasOne("Micro.API.Data.Models.CustomFieldDefinition", "CustomFieldDefinition")
                        .WithMany()
                        .HasForeignKey("CustomFieldDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
